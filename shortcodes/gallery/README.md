...
use this new version instead <https://github.com/flowqi-dev/hugo-modules/tree/master/gallery-slider>
...
```toml
[[imports]]
path = "github.com/flowqi-dev/hugo-modules/shortcodes/gallery"
```
