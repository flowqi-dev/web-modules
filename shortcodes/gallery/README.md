...
use this new version instead <https://github.com/flowqi-dev/web-modules/tree/master/gallery-slider>
...
```toml
[[imports]]
path = "github.com/flowqi-dev/web-modules/shortcodes/gallery"
```
